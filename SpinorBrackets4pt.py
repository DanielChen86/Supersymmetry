...
RA[1] = np.matrix([[data[4]+data[5]*1.j, data[6]+data[7]*1.j],
                  [data[8]+data[9]*1.j, data[10]+data[11]*1.j]])
RA[2] = np.matrix([[data[12]+data[13]*1.j, data[14]+data[15]*1.j],
                  [data[16]+data[17]*1.j, data[18]+data[19]*1.j]])
RA[3] = np.matrix([[data[20]+data[21]*1.j, data[22]+data[23]*1.j],
                  [data[24]+data[25]*1.j, data[26]+data[27]*1.j]])
RA[4] = np.matrix([[data[28]+data[29]*1.j, data[30]+data[31]*1.j],
                  [data[32]+data[33]*1.j, data[34]+data[35]*1.j]])


LB = {}
LB[0] = np.matrix([data[36]+data[37]*1.j, data[38]+data[39]*1.j])
LB[1] = np.matrix([[data[40]+data[41]*1.j, data[42]+data[43]*1.j],
                  [data[44]+data[45]*1.j, data[46]+data[47]*1.j]])
LB[2] = np.matrix([[data[48]+data[49]*1.j, data[50]+data[51]*1.j],
                  [data[52]+data[53]*1.j, data[54]+data[55]*1.j]])
LB[3] = np.matrix([[data[56]+data[57]*1.j, data[58]+data[59]*1.j],
                  [data[60]+data[61]*1.j, data[62]+data[63]*1.j]])
LB[4] = np.matrix([[data[64]+data[65]*1.j, data[66]+data[67]*1.j],
                  [data[68]+data[69]*1.j, data[70]+data[71]*1.j]])
