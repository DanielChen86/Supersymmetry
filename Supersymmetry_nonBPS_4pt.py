...
for A in range(1, 3):
    ...
    for i in range(1, 3):
        for I in range(2):
            DaL_upper[A] += SUSY(FL12*Num(ref*RA[i][:, I]),
                                 [str(i)+str(I)+str(A)])
for A in range(3, 5):
    DaL_upper[A] = SUSY_zeros()
    for i in range(1, 3):
        for I in range(2):
            DaL_upper[A] += SUSY(FL34*Num(ref*RA[i][:, I]),
                                 [str(i)+str(I)+str(A)])
...
for A in range(1, 3):
    ...
    for B in range(1, 3):
        for i in range(1, 3):
            for I in range(2):
                DbL_upper[A] += SUSY((-GL12)*Num(ref*RB[i][:, I])
...
for A in range(3, 5):
    ...
    for B in range(3, 5):
        for i in range(1, 3):
            for I in range(2):
                DbL_upper[A] += SUSY((-GL34)*Num(ref*RB[i][:, I])
                                     * sig[i]*epsilonL(A, B), [str(i)+str(I)+str(B)])
...
for A in range(1, 3):
    ...
    for i in range(1, 3):
        for I in range(2):
            for J in range(2):
                for B in range(1, 3):
                    DaL_lower[A] += Diff(GL12*sig[i]*Num(ref*RA[i][:, I])
...
for A in range(3, 5):
    ...
    for i in range(1, 3):
        for I in range(2):
            for J in range(2):
                for B in range(3, 5):
                    DaL_lower[A] += Diff(GL34*sig[i]*Num(ref*RA[i][:, I])
                                         * epsilonU(A, B)*epsilon_L[I, J], str(i)+str(J)+str(B))
...
for A in range(1, 3):
    ...
    for i in range(1, 3):
        for I in range(2):
            for J in range(2):
                DbL_lower[A] += Diff(-FL12*Num(ref*RB[i][:, I])
...
for A in range(3, 5):
    ...
    for i in range(1, 3):
        for I in range(2):
            for J in range(2):
                DbL_lower[A] += Diff(-FL34*Num(ref*RB[i][:, I])
                                     * epsilon_L[I, J], str(i)+str(J)+str(A))
...
for A in range(1, 3):
    ...
    for i in range(3, 5):
        for I in range(2):
            DaR_upper[A] += SUSY(FR12*Num(ref*RA[i][:, I]),
                                 [str(i)+str(I)+str(A)])
for A in range(3, 5):
    DaR_upper[A] = SUSY_zeros()
    for i in range(3, 5):
        for I in range(2):
            DaR_upper[A] += SUSY(FR34*Num(ref*RA[i][:, I]),
                                 [str(i)+str(I)+str(A)])
...
for A in range(1, 3):
    ...
    for B in range(1, 3):
        for i in range(3, 5):
            for I in range(2):
                DbR_upper[A] += SUSY((-GR12)*Num(ref*RB[i][:, I])
                                     * sig[i]*epsilonL(A, B), [str(i)+str(I)+str(B)])
for A in range(3, 5):
    DbR_upper[A] = SUSY_zeros()
    for B in range(3, 5):
        for i in range(3, 5):
            for I in range(2):
                DbR_upper[A] += SUSY((-GR34)*Num(ref*RB[i][:, I])
                                     * sig[i]*epsilonL(A, B), [str(i)+str(I)+str(B)])
...
for A in range(1, 3):
    ...
    for i in range(3, 5):
        for I in range(2):
            for J in range(2):
                for B in range(1, 3):
                    DaR_lower[A] += Diff(GR12*sig[i]*Num(ref*RA[i][:, I])
                                         * epsilonU(A, B)*epsilon_L[I, J], str(i)+str(J)+str(B))
for A in range(3, 5):
    DaR_lower[A] = Diff_zeros()
    for i in range(3, 5):
        for I in range(2):
            for J in range(2):
                for B in range(3, 5):
                    DaR_lower[A] += Diff(GR34*sig[i]*Num(ref*RA[i][:, I])
                                         * epsilonU(A, B)*epsilon_L[I, J], str(i)+str(J)+str(B))
...
for A in range(1, 3):
    ...
    for i in range(3, 5):
        for I in range(2):
            for J in range(2):
                DbR_lower[A] += Diff(-FR12*Num(ref*RB[i][:, I])
                                     * epsilon_L[I, J], str(i)+str(J)+str(A))
for A in range(3, 5):
    DbR_lower[A] = Diff_zeros()
    for i in range(3, 5):
        for I in range(2):
            for J in range(2):
                DbR_lower[A] += Diff(-FR34*Num(ref*RB[i][:, I])
                                     * epsilon_L[I, J], str(i)+str(J)+str(A))
...
for A in range(1, 3):
    for i in range(1, 3):
        for I in range(2):
            Da_upper[A] += SUSY(FL12*Num(ref*RA[i][:, I]),
                                [str(i)+str(I)+str(A)])
for A in range(3, 5):
    for i in range(1, 3):
        for I in range(2):
            Da_upper[A] += SUSY(FL34*Num(ref*RA[i][:, I]),
                                [str(i)+str(I)+str(A)])
for A in range(1, 3):
    for i in range(3, 5):
        for I in range(2):
            Da_upper[A] += SUSY(FR12*Num(ref*RA[i][:, I]),
                                [str(i)+str(I)+str(A)])
for A in range(3, 5):
    for i in range(3, 5):
        for I in range(2):
            Da_upper[A] += SUSY(FR34*Num(ref*RA[i][:, I]),
                                [str(i)+str(I)+str(A)])
...
for A in range(1, 3):
    for i in range(1, 3):
        for I in range(2):
            for J in range(2):
                for B in range(1, 3):
                    Da_lower[A] += Diff(GL12*sig[i]*Num(ref*RA[i][:, I])
                                        * epsilonU(A, B)*epsilon_L[I, J], str(i)+str(J)+str(B))
for A in range(3, 5):
    for i in range(1, 3):
        for I in range(2):
            for J in range(2):
                for B in range(3, 5):
                    Da_lower[A] += Diff(GL34*sig[i]*Num(ref*RA[i][:, I])
                                        * epsilonU(A, B)*epsilon_L[I, J], str(i)+str(J)+str(B))
for A in range(1, 3):
    for i in range(3, 5):
        for I in range(2):
            for J in range(2):
                for B in range(1, 3):
                    Da_lower[A] += Diff(GR12*sig[i]*Num(ref*RA[i][:, I])
                                        * epsilonU(A, B)*epsilon_L[I, J], str(i)+str(J)+str(B))
for A in range(3, 5):
    for i in range(3, 5):
        for I in range(2):
            for J in range(2):
                for B in range(3, 5):
                    Da_lower[A] += Diff(GR34*sig[i]*Num(ref*RA[i][:, I])
                                        * epsilonU(A, B)*epsilon_L[I, J], str(i)+str(J)+str(B))
...
for A in range(1, 3):
    for B in range(1, 3):
        for i in range(1, 3):
            for I in range(2):
                Db_upper[A] += SUSY((-GL12)*Num(ref*RB[i][:, I])
                                    * sig[i]*epsilonL(A, B), [str(i)+str(I)+str(B)])
for A in range(3, 5):
    for B in range(3, 5):
        for i in range(1, 3):
            for I in range(2):
                Db_upper[A] += SUSY((-GL34)*Num(ref*RB[i][:, I])
                                    * sig[i]*epsilonL(A, B), [str(i)+str(I)+str(B)])
for A in range(1, 3):
    for B in range(1, 3):
        for i in range(3, 5):
            for I in range(2):
                Db_upper[A] += SUSY((-GR12)*Num(ref*RB[i][:, I])
                                    * sig[i]*epsilonL(A, B), [str(i)+str(I)+str(B)])
for A in range(3, 5):
    for B in range(3, 5):
        for i in range(3, 5):
            for I in range(2):
                Db_upper[A] += SUSY((-GR34)*Num(ref*RB[i][:, I])
                                    * sig[i]*epsilonL(A, B), [str(i)+str(I)+str(B)])
...
for A in range(1, 3):
    for i in range(1, 3):
        for I in range(2):
            for J in range(2):
                Db_lower[A] += Diff(-FL12*Num(ref*RB[i][:, I])
                                    * epsilon_L[I, J], str(i)+str(J)+str(A))
for A in range(3, 5):
    for i in range(1, 3):
        for I in range(2):
            for J in range(2):
                Db_lower[A] += Diff(-FL34*Num(ref*RB[i][:, I])
                                    * epsilon_L[I, J], str(i)+str(J)+str(A))
for A in range(1, 3):
    for i in range(3, 5):
        for I in range(2):
            for J in range(2):
                Db_lower[A] += Diff(-FR12*Num(ref*RB[i][:, I])
                                    * epsilon_L[I, J], str(i)+str(J)+str(A))
for A in range(3, 5):
    for i in range(3, 5):
        for I in range(2):
            for J in range(2):
                Db_lower[A] += Diff(-FR34*Num(ref*RB[i][:, I])
                                    * epsilon_L[I, J], str(i)+str(J)+str(A))
...
for A in range(1, 5):
    ...
    for i in range(1, 3):
        for I in range(2):
            HaL[A] += SUSY(Num(zeta*RA[i][:, I]) /
                           Num(zeta*RA[0]), [str(i)+str(I)+str(A)])
...
for A in range(1, 5):
    ...
    for B in range(1, 5):
        for i in range(1, 3):
            for I in range(2):
                HbL[A] += SUSY(Num(xi*RB[i][:, I])*sig[i]*epsilonL(A,
                               B, err=False)/Num(xi*RB[0]), [str(i)+str(I)+str(B)])
...
for A in range(1, 5):
    ...
    for B in range(1, 5):
        for i in range(3, 5):
            for I in range(2):
                HbR[A] += SUSY(Num(xi*RB[i][:, I])*sig[i]*epsilonL(A,
                               B, err=False)/Num(xi*RB[0]), [str(i)+str(I)+str(B)])
...
solutionL12[1] += deltaL12*etaPs12 * \
    (1+(-2*GL12/FL12)*HHabL12+(GL12**2/FL12**2)*HHaL12*HHbL12)
for (A, B) in product(*([range(1, 3)]*2)):
...
solutionL12[2] += deltaL12*((GL12**2)+(2*FL12*GL12)
                            * HHabL12+(FL12**2)*HHaL12*HHbL12)
...
solutionL34[1] += deltaL34*etaPs34 * \
    (1+(-2*GL34/FL34)*HHabL34+(GL34**2/FL34**2)*HHaL34*HHbL34)
for (A, B) in product(*([range(3, 5)]*2)):
...
solutionL34[2] += deltaL34*((GL34**2)+(2*FL34*GL34)
                            * HHabL34+(FL34**2)*HHaL34*HHbL34)
...
solutionR12[1] += deltaR12*etaPs12 * \
    (1+(2*GR12/FR12)*HHabR12+(GR12**2/FR12**2)*HHaR12*HHbR12)
for (A, B) in product(*([range(1, 3)]*2)):
...
solutionR12[2] += deltaR12*((GR12**2)-(2*FR12*GR12)
                            * HHabR12+(FR12**2)*HHaR12*HHbR12)
...
solutionR34[1] += deltaR34*etaPs34 * \
    (1+(2*GR34/FR34)*HHabR34+(GR34**2/FR34**2)*HHaR34*HHbR34)
for (A, B) in product(*([range(3, 5)]*2)):
...
solutionR34[2] += deltaR34*((GR34**2)-(2*FR34*GR34)
                            * HHabR34+(FR34**2)*HHaR34*HHbR34)
