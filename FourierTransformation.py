...
factorized[1][1]=FZ*etaP[1]*delta[1]-delta[1]*Ha[1]-(FZ*GZ)*delta[1]*Hb[2]*etaP[1]*etaP[2]+GZ*delta[1]*Ha[1]*Hb[2]*etaP[2]
factorized[1][2]=FZ*etaP[2]*delta[2]-delta[2]*Ha[2]+(FZ*GZ)*delta[2]*Hb[1]*etaP[1]*etaP[2]+(GZ)*delta[2]*Ha[2]*Hb[1]*etaP[1]
...
factorizedf[1][1]=FZ*etaPf[1]*deltaf[1]-deltaf[1]*Haf[1]-(FZ*GZ)*deltaf[1]*Hbf[2]*etaPf[1]*etaPf[2]+GZ*deltaf[1]*Haf[1]*Hbf[2]*etaPf[2]
factorizedf[1][2]=FZ*etaPf[2]*deltaf[2]-deltaf[2]*Haf[2]+(FZ*GZ)*deltaf[2]*Hbf[1]*etaPf[1]*etaPf[2]+(GZ)*deltaf[2]*Haf[2]*Hbf[1]*etaPf[1]

factorizedf[2][1]=FZ*deltaf[1]*Haf[1]*Hbf[1]+deltaf[1]*etaPf[1]*Hbf[1]+GZ*deltaf[1]
factorizedf[2][2]=FZ*deltaf[2]*Haf[2]*Hbf[2]+deltaf[2]*etaPf[2]*Hbf[2]+GZ*deltaf[2]
