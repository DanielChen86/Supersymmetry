...
for A in range(1, 3):
    ...
    for i in range(1, 3):
        for I in range(2):
            Da_upper[A] += SUSY(FZ12*Num(ref*RA[i][:, I]),
                                [str(i)+str(I)+str(A)])
for A in range(3, 5):
    Da_upper[A] = SUSY_zeros()
    for i in range(1, 3):
        for I in range(2):
            Da_upper[A] += SUSY(FZ34*Num(ref*RA[i][:, I]),
                                [str(i)+str(I)+str(A)])
for A in range(5, 7):
    Da_upper[A] = SUSY_zeros()
    for i in range(1, 3):
        for I in range(2):
            Da_upper[A] += SUSY(FZ56*Num(ref*RA[i][:, I]),
                                [str(i)+str(I)+str(A)])
for A in range(7, 9):
    Da_upper[A] = SUSY_zeros()
    for i in range(1, 3):
        for I in range(2):
            Da_upper[A] += SUSY(FZ78*Num(ref*RA[i][:, I]),
                                [str(i)+str(I)+str(A)])
...
for A in range(1, 3):
    ...
    for B in range(1, 3):
        for i in range(1, 3):
            for I in range(2):
                Db_upper[A] += SUSY((-GZ12)*Num(ref*RB[i][:, I])
...
for A in range(3, 5):
    ...
    for B in range(3, 5):
        for i in range(1, 3):
            for I in range(2):
                Db_upper[A] += SUSY((-GZ34)*Num(ref*RB[i][:, I])
                                    * sig[i]*epsilonL(A, B), [str(i)+str(I)+str(B)])
for A in range(5, 7):
    Db_upper[A] = SUSY_zeros()
    for B in range(5, 7):
        for i in range(1, 3):
            for I in range(2):
                Db_upper[A] += SUSY((-GZ56)*Num(ref*RB[i][:, I])
                                    * sig[i]*epsilonL(A, B), [str(i)+str(I)+str(B)])
for A in range(7, 9):
    Db_upper[A] = SUSY_zeros()
    for B in range(7, 9):
        for i in range(1, 3):
            for I in range(2):
                Db_upper[A] += SUSY((-GZ78)*Num(ref*RB[i][:, I])
                                    * sig[i]*epsilonL(A, B), [str(i)+str(I)+str(B)])
...
for A in range(1, 3):
    ...
    for i in range(1, 3):
        for I in range(2):
            for J in range(2):
                for B in range(1, 3):
                    Da_lower[A] += Diff(GZ12*sig[i]*Num(ref*RA[i][:, I])
...
for A in range(3, 5):
    ...
    for i in range(1, 3):
        for I in range(2):
            for J in range(2):
                for B in range(3, 5):
                    Da_lower[A] += Diff(GZ34*sig[i]*Num(ref*RA[i][:, I])
                                        * epsilonU(A, B)*epsilon_L[I, J], str(i)+str(J)+str(B))
for A in range(5, 7):
    Da_lower[A] = Diff_zeros()
    for i in range(1, 3):
        for I in range(2):
            for J in range(2):
                for B in range(5, 7):
                    Da_lower[A] += Diff(GZ56*sig[i]*Num(ref*RA[i][:, I])
                                        * epsilonU(A, B)*epsilon_L[I, J], str(i)+str(J)+str(B))
for A in range(7, 9):
    Da_lower[A] = Diff_zeros()
    for i in range(1, 3):
        for I in range(2):
            for J in range(2):
                for B in range(7, 9):
                    Da_lower[A] += Diff(GZ78*sig[i]*Num(ref*RA[i][:, I])
                                        * epsilonU(A, B)*epsilon_L[I, J], str(i)+str(J)+str(B))
...
for A in range(1, 3):
    ...
    for i in range(1, 3):
        for I in range(2):
            for J in range(2):
                Db_lower[A] += Diff(-FZ12*Num(ref*RB[i][:, I])
...
for A in range(3, 5):
    ...
    for i in range(1, 3):
        for I in range(2):
            for J in range(2):
                Db_lower[A] += Diff(-FZ34*Num(ref*RB[i][:, I])
                                    * epsilon_L[I, J], str(i)+str(J)+str(A))
for A in range(5, 7):
    Db_lower[A] = Diff_zeros()
    for i in range(1, 3):
        for I in range(2):
            for J in range(2):
                Db_lower[A] += Diff(-FZ56*Num(ref*RB[i][:, I])
                                    * epsilon_L[I, J], str(i)+str(J)+str(A))
for A in range(7, 9):
    Db_lower[A] = Diff_zeros()
    for i in range(1, 3):
        for I in range(2):
            for J in range(2):
                Db_lower[A] += Diff(-FZ78*Num(ref*RB[i][:, I])
                                    * epsilon_L[I, J], str(i)+str(J)+str(A))
        ...
        for i in range(1, 3):
            for I in range(2):
                Hb[A] += SUSY(Num(xi*RB[i][:, I])*sig[i]*epsilonL(A,
                              B, False)/Num(xi*RB[0]), [str(i)+str(I)+str(B)])
...
solution12[1] += delta12*etaPs12 * \
    (1+(-2*GZ12/FZ12)*HHab12+(GZ12**2/FZ12**2)*HHa12*HHb12)
for (A, B) in product(*([range(1, 3)]*2)):
...
solution34[1] += delta34*etaPs34 * \
    (1+(-2*GZ34/FZ34)*HHab34+(GZ34**2/FZ34**2)*HHa34*HHb34)
for (A, B) in product(*([range(3, 5)]*2)):
...
solution56[1] += delta56*etaPs56 * \
    (1+(-2*GZ56/FZ56)*HHab56+(GZ56**2/FZ56**2)*HHa56*HHb56)
for (A, B) in product(*([range(5, 7)]*2)):
...
solution78[1] += delta78*etaPs78 * \
    (1+(-2*GZ78/FZ78)*HHab78+(GZ78**2/FZ78**2)*HHa78*HHb78)
for (A, B) in product(*([range(7, 9)]*2)):
